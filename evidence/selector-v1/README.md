...
- Frozen new synthetic evaluation: 59 cases, 45 correct dispositions, 43 fallbacks, 15 of 27 expected selectable queries accepted. Two incorrect accepts: latest respiratory rate interpreted as a trend; "latest 3 lab reports" selected with a fixed detail limit of 3 that does not establish latest-three ordering. **These block integration.** We did not retrain on these evaluation failures.
